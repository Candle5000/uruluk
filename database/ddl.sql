...
--* RestoreFromTempTable
create table `quest` (
  `quist_id` INT not null AUTO_INCREMENT comment 'クエストID'
  , `floor_id` INT not null comment 'フロアID'
  ...
  , constraint `quest_PKC` primary key (`quist_id`)
) comment 'クエスト' ;
...
create table `quest_icon` (
  `quist_id` INT not null comment 'クエストID'
  ...
  , constraint `quest_icon_PKC` primary key (`quist_id`,`quest_reward`,`quest_icon_id`)
) comment 'クエストアイコン' ;
...
create table `quest_required_item` (
  `quist_id` INT not null comment 'クエストID'
  , `item_id` INT not null comment 'アイテムID'
  , constraint `quest_required_item_PKC` primary key (`quist_id`,`item_id`)
) comment 'クエスト要求アイテム' ;
...
create table `quest_reward_item` (
  `quist_id` INT not null comment 'クエストID'
  , `item_id` INT not null comment 'アイテムID'
  , constraint `quest_reward_item_PKC` primary key (`quist_id`,`item_id`)
) comment 'クエスト報酬アイテム' ;
